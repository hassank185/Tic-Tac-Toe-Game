...
def scorekeeper():
		...
		if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X"):
			...
			tkinter.messagebox.showinfo("Pypower Tic Tac Toe",pa)
			reset()
		...
		if (button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O"):
			...
			tkinter.messagebox.showinfo("Pypower Tic Tac Toe",pb)
			reset()
...
def draw():
    global gamedraw
    gamedraw = True	
    button1.configure(background = 'brown4')
    button2.configure(background = 'brown4')
    button3.configure(background = 'brown4')
    button4.configure(background = 'brown4')
    button5.configure(background = 'brown4')
    button6.configure(background = 'brown4')
    button7.configure(background = 'brown4')
    button8.configure(background = 'brown4')
    button9.configure(background = 'brown4')
